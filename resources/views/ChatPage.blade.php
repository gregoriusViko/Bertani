            ...
            <div class="border-r border-black">
                ...
                <div class="grid grid-flow-row pt-3">
                    ...
                    <div class="h-auto min-h-[10rem] md:min-h-[25rem] lg:min-h-[32rem] overflow-y-auto">
                        <button
                            class="py-1 w-full pl-1 md:pl-4 pt-4 pb-4 flex items-center justify-start gap-x-1 md:gap-x-0 text-xs md:text-xl font-hind font-medium hover:bg-green-300">
                            <span>
                        ...
                        <button
                            class="w-full pl-1 md:pl-4 pt-4 pb-4 flex items-center justify-start gap-x-1 md:gap-x-0 text-xs md:text-xl font-hind font-medium hover:bg-green-300">
                            <span>
                                {{-- @if ($user && $user->profile_img_link) --}}
                                <img src="./img/bglogin.jpg" alt=""
                                    class="w-4 h-4 md:w-8 md:h-8 md:mr-5 rounded-full object-cover group-hover:text-green-600">
                    ...
                    <div class="pl-3 pb-3 border-b border-black font-bold tracking-tight text-gray-900">
                        <div class="relative flex items-center space-x-4">
                            ...
                            <div class="flex flex-col leading-tight">
                                ...
                                {{-- role --}}
                                <span class="text-xs md:text-lg font-hind font-medium text-gray-600">Junior
                                    Developer</span>
                            </div>
                        </div>
                    </div>
                    <div
                        class=" h-auto min-h-[10rem] md:min-h-[25rem] lg:min-h-[32rem] overflow-y-auto">
                        
                        <x-room-chat></x-room-chat>
                    </div>
                </div>
