<div>
    <div>
        <nav class="flex justify-between items-center w-[90%]  mx-auto">
            ...
            <div
                class="nav-links transition ease-in duration-200 md:static absolute bg-green-600 md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto  w-full flex items-center px-5 py-4">
