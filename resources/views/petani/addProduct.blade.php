<x-layout>
    ...
    <div class="mt-4 px-7 mx-auto max-w-screen-lg" x-data="{ imageUrl: '/img/noimage.png' }">
        <form enctype="multipart/form-data" method="POST" action="{{ route('products.Toko') }}"
            class="grid grid-cols-1 md:grid-cols-2 gap-4 mx-auto max-w-full">
            @csrf
            ...
            <div>
                ...
                <div class="mt-4 relative">
                    ...
                    <select id="categoryDropdown" name="jenis"
                        class="block mt-1 w-full pl-3 pr-3 py-2  border  border-gray-300 hover:bg-gray-50 focus:border-green-600 focus:ring-green-600 rounded-md shadow-md"
                        required>
                        <option disabled selected class="hover:bg-green-600">Pilih Jenis Produk</option>
                        @foreach ($categories as $category)
                            <option class="bg-white hover:bg-green-600" value="{{ $category->category }}">
                ...
                <div class="mt-4 relative">
                    ...
                    <select id="productDropdown" name="nama"
                        class="block mt-1 w-full pl-3 py-2  border  border-gray-300 hover:bg-gray-50 focus:border-green-600 focus:ring-green-600 rounded-md shadow-md"
                        required>
