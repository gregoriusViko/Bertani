            ...
            <div
                ...
                <div
                    ...
                    <img src="./img/logo3.jpg" alt="profile"
                        class="thumbnail md:w-full md:h-full lg:w-full lg:h-full sm:w-1/2 sm:h-1/2 object-cover">
                </div>
                <!-- Nama Produk -->
                <div
                ...
                <div
                    ...
                    {{-- {{ $product->date }} --}}
                    <h4 class="text-sm">{{ $order->order_time->diffForHumans() }}</h4>
                </div>
                <div
                ...
                <div
                    ...
                    <h4 class="bg-yellow-200 rounded-md p-1 inline-block mb-1">{{ $order->order_status }}</h4>
