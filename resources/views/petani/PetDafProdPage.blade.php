        ...
        <div class="font-libre-franklin font-bold mx-auto max-w-7xl px-4 mt-5 mb-2 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div dir="rtl">
                ...
                <button
                    ...
                    <span class="text-base md:text-lg"><ion-icon name="add-circle-outline" class="ml-2 mt-1.5 text-base md:text-lg"></ion-icon></span>
                    Tambah Produk
                </button>
                </a>
            </div>
    ...
    <div id="cardContainer"
        ...
        @foreach ($products as $product)
            <div class="shadow-lg border rounded-lg p-4 grid sm:grid-cols-2 sm:grid-flow-row md:grid-cols-8 md:grid-flow-row lg:grid-cols-8 lg:grid-flow-row gap-4 items-start">
                <!-- Gambar Produk -->
                <div class="row-start-1 sm:col-span-1 sm:row-span-2 md:col-span-3 md:row-span-4 lg:col-span-2 lg:row-span-4 flex justify-center items-center border rounded-lg sm:w-24 sm:h-24 lg:w-60 lg:h-48 md:w-56 md:h-44 md:mt-1 overflow-hidden">
                    <img src="{{ $product->img_link }}" alt="hasil_tani" class="thumbnail md:w-full md:h-full lg:w-full lg:h-full w-1/2 h-1/2 object-cover">
                </div>
                <!-- Nama Produk -->
                <div class="capitalize font-libre-franklin font-semibold sm:col-span-1 md:col-span-3 lg:col-span-4 sm:text-sm md:text-lg lg:text-xl lg:ml-10">
                    {{ $product->type->name }}
                </div>
                <!-- Jenis Produk -->
                <div class="font-libre-franklin font-medium sm:col-span-1 md:row-start-2 md:col-start-4 md:col-span-3 lg:row-start-2 lg:col-start-3 lg:ml-10 lg:col-span-4 sm:text-sm md:text-base lg:text-lg text-gray-600">
                    Jenis Produk: {{ $product->type->category }}
                </div>
                {{-- Tanggal update terbaru --}}
                <div class="font-libre-franklin font-medium row-start-2 sm:col-span-1 md:col-start-7 md:row-start-1 md:col-span-2 lg:row-start-1 lg:col-start-7 lg:col-span-2 text-xs md:text-base lg:text-base text-gray-600 md:flex md:justify-end">
                    {{ $product->updated_at}}
                </div>
                <!-- Harga Produk -->
                <div class="font-libre-franklin font-medium row-start-4 sm:col-span-1 md:col-start-7 md:row-start-2 md:col-span-2 lg:row-start-2 lg:col-start-7 lg:col-span-2 sm:text-base md:text-lg lg:text-2xl md:flex md:justify-end  text-gray-600">
                    {{ Number::currency($product->price, in: 'idr') }}
                </div>
                <!-- Jumlah Stok -->
                <div class="font-libre-franklin font-medium sm:col-span-1 md:row-start-3 md:col-start-4 md:col-span-3 lg:row-start-3 lg:col-start-3 lg:ml-10 lg:col-span-4 sm:text-sm md:text-base lg:text-lg text-gray-600">
                    Sisa Stok: {{ WeightConverter::convert($product->stock_kg) }}
                </div>
                <!-- Jumlah Terjual -->
                <div class="font-libre-franklin font-medium sm:col-span-1 md:row-start-4 md:col-start-4 md:col-span-3 lg:row-start-4 lg:col-start-3 lg:ml-10 lg:col-span-4 sm:text-sm md:text-base lg:text-lg text-gray-600">
