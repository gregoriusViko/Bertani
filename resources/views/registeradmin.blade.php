...
<body>
    <div
        class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]" style="background-image: url('/public/img/bglogin.jpg');">
            ...
            <form class="space-y-4" action="{{ route('register.submit') }}" method="post">
                ...
                <div class="relative flex w-full">
                    ...
                    <ul id="dropdownMenu"
                        ...
                        <li onclick="selectOption('Admin')"
                            class="py-3 px-5 hover:bg-gray-50 text-gray-800 text-sm cursor-pointer">Admin</li>
                    </ul>
                </div>
