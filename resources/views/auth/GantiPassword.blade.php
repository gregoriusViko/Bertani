...
<body>
    <div 
        ...
        <p class="text-black text-3xl font-bold py-8 text-center">Ganti Password</p>
            ...
            <label for="confirm_password" class="block mb-2 text-2xl font-semibold text-black">Konfirmasi Password</label>
                <div class="relative flex items-center">
                    <input type="password" placeholder="Password" name="confrim_password" id="confirm_password"
                        class="px-4 py-2 bg-white text-gray-800 w-full text-sm border border-gray-300 focus:border-green-600 outline-none rounded-lg" />
                    <button type="button" id="toggleConfirmPassword" class="absolute right-4 bg-transparent focus:outline-none">
