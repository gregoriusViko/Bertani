    ...
    <div class="grid grid-cols-2 border border-black rounded-md ">
        <div class="border border-b-black">
            <div class="grid grid-cols-2 font-inter font-semibold my-3 mx-2">
                ...
                <h3>Rp {{number_format($order->product->price * $order->quantity_kg, 0 , ',' , '.')}}</h3>
            </div>
        </div>
        ...
        <div class="border border-b-black border-l-black">
            <div class="ml-4 grid grid-flow-row font-inter  my-3 mx-2">
                ...
                <h3 class="font-normal">"{{$order->product->farmer->bank}} - {{$order->product->farmer->nomor_rekening}} || {{ $order->product->farmer->name }}"</h3>
            </div>
        </div>
        @endif
         ...
         @if ($order->payment_proof === 'COD')
              <div class="border border-1-black">
                <div class="ml-4 grid grid-flow-row font-inter my-3 mx-2">
                    ...
                    <p class="font-normal">Silahkan lakukan pembayaran secara tunai ketika anda mengambil barang di petani.</p>
                    <h3 class="font-normal">Alamat Pengambilan Barang:</h3>
